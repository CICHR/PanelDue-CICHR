	...
	: PopupWindow(ph, pw, pb, pBorder), titleField(nullptr)
{
	...
	AddField(closeButton = new VectorIconButton(popupTopMargin, pw - (closeButtonWidth + popupSideMargin), closeButtonWidth, buttonHeight, VectorIcon::Close, evCancel, nullptr, DEFAULT_FONT, 0));
}
