...
enum Event : uint8_t
{
	...
	evMoveAxis,
	evMoveSelectAxis,
	evMoveBedMap, evModernJog, evModernJogStep, evModernFeedrate,
	evConfigureHomeSlot, evAssignHomeSlot,
	...
	// Setup functions
	evCalTouch, evSetBaudRate, evInvertX, evInvertY, evInvertZ, evAdjustBaudRate, evSetVolume, evAdjustVolume, evSetInfoTimeout, evAdjustInfoTimeout, evReset,
